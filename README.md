...
### Snappy – Make Your Code Look Snappy ✨
...
![code-screenshot](https://ik.imagekit.io/rmlbayysp/1749362497809-Screenshot_2025-06-08_113048_BBFTRN7EQ.png)
...
```bash
git clone https://github.com/Killuax007/Snappy && cd Snappy
```
